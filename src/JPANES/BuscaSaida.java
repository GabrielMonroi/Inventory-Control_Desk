 ...
 * @author Biel
 */
public class BuscaSaida extends javax.swing.JFrame {
    ...
    public void readJTableForDesc(String desc) {
        ...
        for (Cliente c : pdao.readForDesc2(desc)) {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Busca de Saidas Efetuadas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscaSaida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuscaSaida().setVisible(true);
            }
        });
    }
